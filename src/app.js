...
mongoose.connect(`mongodb://${dbConnection.username}:${dbConnection.password}@${dbConnection.address}:${dbConnection.port}/${dbConnection.database}`, { promiseLibrary: require('bluebird'), useNewUrlParser: true })
